...
pro_type = input('ป้อนชประเภทสินค้า (F/f, W/w, M/m, K/k): ')
pro_price = float( input('ป้อนราคาสินค้า: ') )
print('----------------------------------------------------')
if pro_name == 'f' or pro_type == 'f' :
    pro_sale = pro_price - (pro_price * 2 /100)
    print(f'ราคาสินค้าที่่ลดแล้วเป็น {pro_sale} บาท')
    ...
    print('คุณป้อนประเภทผิด !!! ตาย  ตาย ป้อนผิด  ป้อนใหม่อีกครั้งนะ...')
print('----------------------------------------------------')